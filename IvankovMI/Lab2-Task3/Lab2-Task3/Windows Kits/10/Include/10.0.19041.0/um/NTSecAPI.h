...
typedef enum _KERB_PROTOCOL_MESSAGE_TYPE {
    ...
    KerbRefreshPolicyMessageReserved,
...
typedef struct _KERB_CHECK_CLOUD_TGT_AVAILABLE_REQUEST
{
    KERB_PROTOCOL_MESSAGE_TYPE MessageType;
    LUID LogonId;
} KERB_CHECK_CLOUD_TGT_AVAILABLE_REQUEST, *PKERB_CHECK_CLOUD_TGT_AVAILABLE_REQUEST;

typedef struct _KERB_CHECK_CLOUD_TGT_AVAILABLE_RESPONSE
{
    KERB_PROTOCOL_MESSAGE_TYPE MessageType;
    BOOLEAN Result;
} KERB_CHECK_CLOUD_TGT_AVAILABLE_RESPONSE, *PKERB_CHECK_CLOUD_TGT_AVAILABLE_RESPONSE;
