...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Management_Deployment_IAddPackageOptions<D>::StubPackageOption() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Management::Deployment::IAddPackageOptions)->get_StubPackageOption(put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_Management_Deployment_IPackageManager9<D>::GetPackageStubPreference(param::hstring const& packageFamilyName) const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Management::Deployment::IPackageManager9)->GetPackageStubPreference(*(void**)(&packageFamilyName), put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_Management_Deployment_IPackageUserInformation<D>::InstallState() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Management::Deployment::IPackageUserInformation)->get_InstallState(put_abi(value)));
        return value;
    }
    ...
    {
        Windows::Management::Deployment::StubPackageOption value;
        check_hresult(WINRT_IMPL_SHIM(Windows::Management::Deployment::IStagePackageOptions)->get_StubPackageOption(put_abi(value)));
        return value;
    }
...
namespace winrt::Windows::Management::Deployment
{
    ...
    inline AddPackageOptions::AddPackageOptions() :
        AddPackageOptions(impl::call_factory<AddPackageOptions>([](auto&& f) { return f.template ActivateInstance<AddPackageOptions>(); }))
    {
    }
    ...
    inline RegisterPackageOptions::RegisterPackageOptions() :
        RegisterPackageOptions(impl::call_factory<RegisterPackageOptions>([](auto&& f) { return f.template ActivateInstance<RegisterPackageOptions>(); }))
    {
    }
    inline StagePackageOptions::StagePackageOptions() :
        StagePackageOptions(impl::call_factory<StagePackageOptions>([](auto&& f) { return f.template ActivateInstance<StagePackageOptions>(); }))
    {
    }
}
namespace std
{
    template<> struct hash<winrt::Windows::Management::Deployment::IAddPackageOptions> : winrt::impl::hash_base<winrt::Windows::Management::Deployment::IAddPackageOptions> {};
    template<> struct hash<winrt::Windows::Management::Deployment::IAddPackageOptions2> : winrt::impl::hash_base<winrt::Windows::Management::Deployment::IAddPackageOptions2> {};
    ...
    template<> struct hash<winrt::Windows::Management::Deployment::IPackageManager9> : winrt::impl::hash_base<winrt::Windows::Management::Deployment::IPackageManager9> {};
    ...
    template<> struct hash<winrt::Windows::Management::Deployment::IRegisterPackageOptions> : winrt::impl::hash_base<winrt::Windows::Management::Deployment::IRegisterPackageOptions> {};
    template<> struct hash<winrt::Windows::Management::Deployment::IRegisterPackageOptions2> : winrt::impl::hash_base<winrt::Windows::Management::Deployment::IRegisterPackageOptions2> {};
    template<> struct hash<winrt::Windows::Management::Deployment::IStagePackageOptions> : winrt::impl::hash_base<winrt::Windows::Management::Deployment::IStagePackageOptions> {};
    template<> struct hash<winrt::Windows::Management::Deployment::IStagePackageOptions2> : winrt::impl::hash_base<winrt::Windows::Management::Deployment::IStagePackageOptions2> {};
    template<> struct hash<winrt::Windows::Management::Deployment::AddPackageOptions> : winrt::impl::hash_base<winrt::Windows::Management::Deployment::AddPackageOptions> {};
    ...
    template<> struct hash<winrt::Windows::Management::Deployment::RegisterPackageOptions> : winrt::impl::hash_base<winrt::Windows::Management::Deployment::RegisterPackageOptions> {};
    template<> struct hash<winrt::Windows::Management::Deployment::StagePackageOptions> : winrt::impl::hash_base<winrt::Windows::Management::Deployment::StagePackageOptions> {};
}
#endif
