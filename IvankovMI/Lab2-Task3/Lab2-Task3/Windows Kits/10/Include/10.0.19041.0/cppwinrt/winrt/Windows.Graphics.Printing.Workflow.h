...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Graphics_Printing_Workflow_IPrintWorkflowConfiguration2<D>::AbortPrintFlow(Windows::Graphics::Printing::Workflow::PrintWorkflowJobAbortReason const& reason) const
    {
    ...
    {
        Windows::Graphics::Printing::Workflow::PrintWorkflowSessionStatus value;
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Printing::Workflow::IPrintWorkflowJobBackgroundSession)->get_Status(put_abi(value)));
        return value;
    }
    ...
    {
        Windows::Graphics::Printing::Workflow::PrintWorkflowSessionStatus value;
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Printing::Workflow::IPrintWorkflowJobUISession)->get_Status(put_abi(value)));
        return value;
    }
    ...
    template <typename D> auto consume_Windows_Graphics_Printing_Workflow_IPrintWorkflowObjectModelSourceFileContentFactory<D>::CreateInstance(Windows::Storage::Streams::IInputStream const& xpsStream) const
    {
        void* value{};
    ...
    template <typename D> auto consume_Windows_Graphics_Printing_Workflow_IPrintWorkflowPdlConverter<D>::ConvertPdlAsync(Windows::Graphics::Printing::PrintTicket::WorkflowPrintTicket const& printTicket, Windows::Storage::Streams::IInputStream const& inputStream, Windows::Storage::Streams::IOutputStream const& outputStream) const
    {
        void* operation{};
    ...
    template <typename D> auto consume_Windows_Graphics_Printing_Workflow_IPrintWorkflowPdlModificationRequestedEventArgs<D>::CreateJobOnPrinterWithAttributesBuffer(Windows::Storage::Streams::IBuffer const& jobAttributesBuffer, param::hstring const& targetContentType) const
    {
        void* result{};
    ...
    template <typename D> auto consume_Windows_Graphics_Printing_Workflow_IPrintWorkflowPdlModificationRequestedEventArgs<D>::GetPdlConverter(Windows::Graphics::Printing::Workflow::PrintWorkflowPdlConversionType const& conversionType) const
    {
        void* result{};
    ...
    template <typename D> auto consume_Windows_Graphics_Printing_Workflow_IPrintWorkflowPdlTargetStream<D>::CompleteStreamSubmission(Windows::Graphics::Printing::Workflow::PrintWorkflowSubmittedStatus const& status) const
    {
    ...
    template <typename D> auto consume_Windows_Graphics_Printing_Workflow_IPrintWorkflowPrinterJob<D>::GetJobStatus() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Printing::Workflow::IPrintWorkflowPrinterJob)->GetJobStatus(put_abi(result)));
        return result;
    }
    ...
    template <typename D> auto consume_Windows_Graphics_Printing_Workflow_IPrintWorkflowPrinterJob<D>::SetJobAttributesFromBuffer(Windows::Storage::Streams::IBuffer const& jobAttributesBuffer) const
    {
        void* result{};
    ...
    template <typename D> auto consume_Windows_Graphics_Printing_Workflow_IPrintWorkflowPrinterJob<D>::SetJobAttributes(param::iterable<Windows::Foundation::Collections::IKeyValuePair<hstring, Windows::Devices::Printers::IppAttributeValue>> const& jobAttributes) const
    {
        void* result{};
...
namespace winrt::Windows::Graphics::Printing::Workflow
{
    inline PrintWorkflowObjectModelSourceFileContent::PrintWorkflowObjectModelSourceFileContent(Windows::Storage::Streams::IInputStream const& xpsStream) :
        PrintWorkflowObjectModelSourceFileContent(impl::call_factory<PrintWorkflowObjectModelSourceFileContent, Windows::Graphics::Printing::Workflow::IPrintWorkflowObjectModelSourceFileContentFactory>([&](auto&& f) { return f.CreateInstance(xpsStream); }))
    {
    }
}
namespace std
{
    ...
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowConfiguration2> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowConfiguration2> {};
    ...
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowJobActivatedEventArgs> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowJobActivatedEventArgs> {};
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowJobBackgroundSession> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowJobBackgroundSession> {};
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowJobNotificationEventArgs> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowJobNotificationEventArgs> {};
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowJobStartingEventArgs> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowJobStartingEventArgs> {};
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowJobTriggerDetails> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowJobTriggerDetails> {};
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowJobUISession> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowJobUISession> {};
    ...
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowObjectModelSourceFileContentFactory> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowObjectModelSourceFileContentFactory> {};
    ...
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowPdlConverter> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowPdlConverter> {};
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowPdlDataAvailableEventArgs> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowPdlDataAvailableEventArgs> {};
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowPdlModificationRequestedEventArgs> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowPdlModificationRequestedEventArgs> {};
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowPdlSourceContent> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowPdlSourceContent> {};
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowPdlTargetStream> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowPdlTargetStream> {};
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowPrinterJob> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowPrinterJob> {};
    ...
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowUILauncher> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::IPrintWorkflowUILauncher> {};
    ...
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowJobActivatedEventArgs> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowJobActivatedEventArgs> {};
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowJobBackgroundSession> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowJobBackgroundSession> {};
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowJobNotificationEventArgs> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowJobNotificationEventArgs> {};
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowJobStartingEventArgs> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowJobStartingEventArgs> {};
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowJobTriggerDetails> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowJobTriggerDetails> {};
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowJobUISession> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowJobUISession> {};
    ...
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowPdlConverter> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowPdlConverter> {};
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowPdlDataAvailableEventArgs> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowPdlDataAvailableEventArgs> {};
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowPdlModificationRequestedEventArgs> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowPdlModificationRequestedEventArgs> {};
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowPdlSourceContent> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowPdlSourceContent> {};
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowPdlTargetStream> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowPdlTargetStream> {};
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowPrinterJob> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowPrinterJob> {};
    ...
    template<> struct hash<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowUILauncher> : winrt::impl::hash_base<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowUILauncher> {};
