 ...
 void main()
{
    ...
    if ((s+r1)<r)
	{
		printf("Вторая окружности находится внутри первой!\n");
		return;
	}
	if ((s+r==r1)||(s+r1==r))
	{
		printf("Окружности пересекаются внутренним образом один раз!\n");
		return;
	}
	if ((s+r)<r1)
	{
	
		printf("Первая окружности находится внутри второй!\n");
		return;
	}
