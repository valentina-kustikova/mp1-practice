...
int main() {
	...
	// Все фигуры отличаются своей последней буквой, значит я могу считывать буквы столько сколько захочу и инициализировать фигуру по последней букве
	// Если мне вводят какую-то чухню, последняя буква которой совпадает с какой то из "фигурных", то я проигрываю!!
	return 0;
}
